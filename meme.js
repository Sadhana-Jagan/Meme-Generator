...
*/
function clearAll() {
  const memetag = document.querySelector('.meme-div');
  const joketag = document.querySelector('.joke-div');
  const wisdomtag = document.querySelector('.wisdom-div');
  const riddletag = document.querySelector('.riddle-div');
...
function showMeme() {
  ...
  const divtag = document.querySelector('.meme-div');
...
function showJoke() {
  ...
  const divtag = document.querySelector('.joke-div');
...
function showQuote() {
  ...
  const divtag = document.querySelector('.wisdom-div');
...
function showRiddle() {
  ...
  const divtag = document.querySelector('.riddle-div');
  const ptag = document.createElement('p');
  ptag.textContent = riddle;
  const answertag = document.createElement('p');
  answertag.textContent = answer;
  answertag.hidden = true;
  answertag.setAttribute('id','riddle-ans');
  const p = divtag.querySelector('p');
  clearAll();
  divtag.appendChild(ptag);
  divtag.appendChild(answertag);
}
...
function revealAnswers() {
  ...
  const checkptag = riddlediv.querySelector('p');
  const anstag = riddlediv.querySelector('#riddle-ans');
  
  if(!checkptag){
    alert('ask for a riddle first');
  }
  else if(checkptag && anstag.hidden){
    anstag.hidden = false;
  }
  else if(checkptag && !anstag.hidden){
